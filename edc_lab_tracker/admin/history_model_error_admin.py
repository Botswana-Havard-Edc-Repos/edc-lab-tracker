...
class HistoryModelErrorAdmin(BaseModelAdmin):
    list_display = ('subject_identifier', 'group_name', 'test_code', 'value', 'value_datetime', 'source_model_name',
                    'source_app_label','source_identifier', 'history_datetime', 'modified')
